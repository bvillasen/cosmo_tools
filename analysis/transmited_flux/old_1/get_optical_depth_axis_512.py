...
uvb = 'pchw18'
# uvb = 'hm12'
input_dir = dataDir + 'cosmo_sims/512_hydro_50Mpc/skewers_{0}/'.format(uvb)
output_dir = dataDir + 'cosmo_sims/512_hydro_50Mpc/optical_depth_{0}/multiple_axis/'.format(uvb)
