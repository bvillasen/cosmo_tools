...
uvb = 'pchw18'
# uvb = 'hm12'
input_dir = dataDir + 'cosmo_sims/2048_hydro_50Mpc_{1}/skewers_{0}/'.format(uvb, cosmo_name)
output_dir = dataDir + 'cosmo_sims/2048_hydro_50Mpc_{1}/optical_depth_{0}/multiple_axis/'.format(uvb, cosmo_name)
