...
uvb = 'pchw18'
# uvb = 'hm12'
input_dir = dataDir + 'cosmo_sims/1024_hydro_50Mpc/skewers_{0}/'.format(uvb)
output_dir = dataDir + 'cosmo_sims/1024_hydro_50Mpc/optical_depth_{0}/multiple_axis/'.format(uvb)
snapshots_indices = list(range( 74, 170, 1))
# snapshots_indices = range( 74, 99, 1 )
