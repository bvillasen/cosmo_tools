...
inDir = dataDir + 'cosmo_sims/{0}_hydro_50Mpc_{2}/output_files_{1}/'.format(nPoints, uvb, cosmo_name )
output_dir = dataDir + 'cosmo_sims/{0}_hydro_50Mpc_{2}/skewers_{1}/'.format(nPoints, uvb, cosmo_name )
