...
for space in cosmo_spaces:
  ...
  for i,skewer_id in enumerate(skewers_ids):
    ...
    if interpolate: x_comov, vel_Hubble, n_HI_los, tau_redshift = compute_optical_depth_interpolate( H0, cosmo_h, Omega_M, Omega_L, Lbox, nPoints,  current_z, density, HI_density, temperature, velocity, interpolation_factor=8, space=space )
    else: x_comov, vel_Hubble, n_HI_los, tau_redshift = compute_optical_depth( H0, cosmo_h, Omega_M, Omega_L, Lbox, nPoints,  current_z, density, HI_density, temperature, velocity, space=space )
