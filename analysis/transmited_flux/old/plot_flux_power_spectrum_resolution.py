...
uvb = 'pchw18'
uvb = 'hm12'
output_dir = dataDir + 'cosmo_sims/{0}_hydro_50Mpc/figures/transmited_flux/power_spectrum/resolution/'.format(nPoints, uvb)
...
ncols = 1
fig, ax = plt.subplots(nrows=nrows, ncols=ncols, figsize=(8*ncols,5*nrows))
...
uvb = 'pchw18'
input_dir = dataDir + 'cosmo_sims/{0}_hydro_50Mpc/transmited_flux_{1}/new_2/power_spectrum_bins{2}{3}/'.format(nPoints, uvb, n_bins, binning)
...
if nrows == 1: fileName = output_dir + 'flux_power_spectrum_all_data_black_z5.png'
if nrows == 2: fileName = output_dir + 'flux_power_spectrum_all_data_black_z2.png'

if smooth:
  if nrows == 1: fileName = output_dir + 'flux_power_spectrum_all_data_black_z5_smooth.png'
  if nrows == 2: fileName = output_dir + 'flux_power_spectrum_all_data_black_z2_smooth.png'
  
  if transparent:
    if nrows == 1: fileName = output_dir + 'flux_power_spectrum_all_data_black_z5_smooth_transparent_l1.png'
    if nrows == 2: fileName = output_dir + 'flux_power_spectrum_all_data_black_z2_smooth_transparent_l1.png'
