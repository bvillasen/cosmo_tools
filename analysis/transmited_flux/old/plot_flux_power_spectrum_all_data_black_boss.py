...
uvb = 'pchw18'
uvb = 'hm12'
output_dir = dataDir + 'cosmo_sims/{0}_hydro_50Mpc/figures/transmited_flux/power_spectrum/new/boss/'.format(nPoints, uvb)
...
if nrows == 1: fileName = output_dir + 'flux_power_spectrum_all_data_black_z4_boss.png'
if nrows == 2: fileName = output_dir + 'flux_power_spectrum_all_data_black_z2_boss.png'

if smooth:
  if nrows == 1: fileName = output_dir + 'flux_power_spectrum_all_data_black_z4_smooth.png'
  if nrows == 2: fileName = output_dir + 'flux_power_spectrum_all_data_black_z2_smooth.png'

  if transparent:
    if nrows == 1: fileName = output_dir + 'flux_power_spectrum_all_data_black_z4_smooth_transparent.png'
    if nrows == 2: fileName = output_dir + 'flux_power_spectrum_all_data_black_z2_smooth_transparent.png'
