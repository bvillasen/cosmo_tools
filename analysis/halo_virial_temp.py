...
chollaDir = dataDir + 'cosmo_sims/cholla_pm/256_dm_50Mpc/'
halosDir = chollaDir + 'halos/'
snapshotsDir = chollaDir + 'data_enzo_grav4/'
outDir = dev_dir + 'figures/virial_temperature/'
...
n_cholla_files = 2
chollaDir_0 = dataDir + 'cosmo_sims/cholla_pm/256_hydro_50Mpc/data_SIMPLE_PPMP_eta0.010_beta0.00_grav4/'
chollaDir_1 = dataDir + 'cosmo_sims/cholla_pm/256_hydro_50Mpc/data_SIMPLE_PPMP_eta0.030_beta0.00_grav4/'
chollaDir_all = [ chollaDir_0, chollaDir_1 ]
chollaLabel_all = [r'Cholla $\eta=0.010$', r'Cholla $\eta=0.035$' ]
...
ax.plot( z_list, t_vir_list,  '--', c='C9', linewidth=2,  label='Virial')
...
fileName = 'virial_temperature_all_uv.png'
