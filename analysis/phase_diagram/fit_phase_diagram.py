...
input_dir = dataDir + 'cosmo_sims/512_hydro_50Mpc/phase_diagram_pchw18/'
if fit_type == 'scipy': output_dir = input_dir + 'fit_scipy/'
if fit_type == 'mcmc': output_dir = input_dir + 'fit_mcmc/'
...
for nSnap in range(170):
  ...
  pcov = np.sqrt( fit_pcov[0,1] )
  # Save fit to file 
  h = "T0, gamma, T_0_sigma, gamma_sigma, delta_left, delta_right, pcov"
