...
n_plots = 2
fileNames_0 = [ ps_dir + 'ps_{0}_cool_uv_dm_cholla_enzo.dat'.format( nPoints ), ps_dir + 'ps_{0}_cool_uv_dm_enzo.dat'.format( nPoints ) ]
data_0 = [ np.loadtxt( fileNames_0[i]) for i in range(len(fileNames_0))]


fileNames_1 = [ ps_dir + 'ps_{0}_cool_uv_gas_cholla_enzo.dat'.format( nPoints ), ps_dir + 'ps_{0}_cool_uv_gas_enzo.dat'.format( nPoints ) ]
