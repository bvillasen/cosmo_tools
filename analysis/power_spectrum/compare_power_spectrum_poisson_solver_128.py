...
inputDir_paris = dataDir + 'cosmo_sims/128_dm_50Mpc/snapshots_cufft/'
inputDir_pfft = dataDir + 'cosmo_sims/128_dm_50Mpc/snapshots_sor/'
outDir = dataDir + 'cosmo_sims/128_dm_50Mpc/figures/'
...
snapshots = [ 0, 2, 4, 6, 8, 10,  14,  18,  22,  26]
# snapshots = [ 0,  26]
...
out_file_name = 'ps_comparison_cufft_sor_128.png'
